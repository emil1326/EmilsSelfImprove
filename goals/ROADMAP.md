...
- [ ] **Piece 022+ / harvest `caustics`** — likely a dedicated primitive harvest: factor the caustic web from god-rays + koi (2 consumers, [[019-harvest-primitives-from-duplication]]) into `lib/caustics.js`, refactor both onto it WITHOUT regressing god-rays (5/5 — verify per [[031-verify-refactor-by-logic-not-just-pixel-hash]]). Or weave by the next genuine pull. Genuine-"oh!" bar (028).
