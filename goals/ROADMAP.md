...
- [ ] **Piece 019 'god-rays' (next)** — the achievable expression of the same light-in-water pull: underwater sunbeams slanting through deep blue + motes + caustics, reusing the additive-vertical-light tech. STATIC (rAF throttled → unverifiable motion). Then 020+ by the next genuine pull. Genuine "oh!" bar (028).
